...
<?php $__env->startSection('lib'); ?>
  <link rel="stylesheet" href="<?php echo asset('public/css/koki.css'); ?>">
  <script type="text/javascript" src="<?php echo asset('public/js/koki.js'); ?>"></script>
...
<?php $__env->startSection('content'); ?>
  <?php echo $__env->make('koki.operation.dashboard', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
