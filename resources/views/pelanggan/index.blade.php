<html>
  ...
  <link rel="stylesheet" href="{!!asset('public/css/pemesanan.css')!!}">
  ...
  <script type="text/javascript" src="{!!asset('public/js/pemesanan.js')!!}"></script>
  <body>
    <div id="load"></div>
    <div id="popupBox">
        ...
        <div class="kelompok_tipe">
          ...
          @if (count($APPS)>0)
            @foreach ($APPS as $APP)
              ...
              @endphp
              <div class="dishpanel animasi" onclick="set_order({{$APP->no}},'{{$APP->nama}}',{{$APP->harga}})">
                <img src="{{$url}}">
                <div class="info">
                  <table>
                    <tr>
                    ...
                    <tr>
                      <th>Rp. {{number_format($APP->harga,0,',','.')}}</th>
                    </tr>
                  </table>
                </div>
              </div>
        ...
        <div class="kelompok_tipe">
          ...
          @if (count($MACS)>0)
            @foreach ($MACS as $MAC)
              ...
              @endphp
              <div class="dishpanel animasi" onclick="set_order({{$MAC->no}},'{{$MAC->nama}}',{{$MAC->harga}})">
                <img src="{{$url}}">
                <div class="info">
                  <table>
                    <tr>
                    ...
                    <tr>
                      <th>Rp. {{number_format($MAC->harga,0,',','.')}}</th>
                    </tr>
                  </table>
                </div>
              </div>
        ...
        <div class="kelompok_tipe">
          ...
          @if (count($DESS)>0)
            @foreach ($DESS as $DES)
              ...
              @endphp
              <div class="dishpanel animasi" onclick="set_order({{$DES->no}},'{{$DES->nama}}',{{$DES->harga}})">
                <img src="{{$url}}">
                <div class="info">
                  <table>
                    <tr>
                    ...
                    <tr>
                      <th>Rp. {{number_format($DES->harga,0,',','.')}}</th>
                    </tr>
                  </table>
                </div>
              </div>
        ...
        <div class="kelompok_tipe">
          ...
          @if (count($SOFS)>0)
            @foreach ($SOFS as $SOF)
              ...
              @endphp
              <div class="dishpanel animasi" onclick="set_order({{$SOF->no}},'{{$SOF->nama}}',{{$SOF->harga}})">
                <img src="{{$url}}">
                <div class="info">
                  <table>
                    <tr>
                    ...
                    <tr>
                      <th>Rp. {{number_format($SOF->harga,0,',','.')}}</th>
                    </tr>
                  </table>
                </div>
              </div>
    ...
    <input type="hidden" id="temploop" value={{$_SESSION["statusbayar"]}}>
  </body>
