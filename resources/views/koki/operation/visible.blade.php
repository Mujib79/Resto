...
<div class="panel-header">
  <button type="button" class="green animasi" id="simpan" onclick="update_food({{$data->no_hidangan}})" name="button">Simpan</button>
    ...
    <div class="form-isian" enctype="multipart/form-data">
      <fieldset class="form-dish">
        ...
        *Harga Hidangan:
        ...
        Cara Buat:
        <textarea class="animasi" name="cara_buat" placeholder="Ketikkan disini" rows="8" cols="80">{{$data->cara_buat}}</textarea>
      </fieldset>
    </div>
