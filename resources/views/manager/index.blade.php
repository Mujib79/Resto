...
@section('lib')
  <link rel="stylesheet" href="{!!asset('public/css/manager.css')!!}">
  <script type="text/javascript" src="{!!asset('public/js/manager.js')!!}"></script>
...
@section('content')
  @include('manager.operation.dashboard')
@endsection
